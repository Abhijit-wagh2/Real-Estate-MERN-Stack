  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p className='text-sm self-center'>
        {
        fileUploadError ? (<span className="text-red-700">Upload failed</span>)
        : filePerc > 0 && filePerc < 100 ? (<span className="text-slate-700">{`Uploading ${filePerc}%`} </span> ):
        filePerc == 100 ?(<span  className="text-green-700">Upload success</span> ): ("")
        } 
      </p>
      ...
      <img onClick={() => fileRef.current.click()} src={currentUser.avatar}  alt={currentUser.username} className="rounded-full h-24 w-24 object-cover mx-auto cursor-pointer self-center mt-2" 
        />
